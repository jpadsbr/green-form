function searchCity(value) {
  ...
  var stateNumber = locations.states.length;
  var locationsIndex = -1;

  for (var i = 0; i < stateNumber; i++) {
    if (locations.states[i].state == value) {
      locationsIndex = i;
    }
  }

  if (locationsIndex != -1) {
    locations.states[locationsIndex].cities.forEach(function (location) {
      var cityOption = document.createElement('option');
      cityOption.setAttribute('value', location)
      cityOption.innerHTML = location;
